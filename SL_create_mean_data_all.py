...
data_dir = datadir + "GR0/hyperaligned/"
...
# Create empty array
data_allSubs = np.zeros((x_dim, y_dim, z_dim, time_dim))

# Load data per subject and add to array
...
# Take average
data_mean = data_allSubs / num_subjects

np.save(save_dir + 'mean_wholeBrain_allSubs', data_mean)
print("Done")
